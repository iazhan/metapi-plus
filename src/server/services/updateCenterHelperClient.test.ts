...
describe('update center helper client', () => {
  ...
  it('posts digest-aware deploy payloads to the helper and parses the streamed result', async () => {
    fetchMock.mockResolvedValue(new Response([
      ...
      '',
      'event: result',
      'data: {"success":true,"targetSource":"container-tag","targetTag":"latest","targetDigest":"sha256:efb2ee6553866bd3268dcc54c02fa5f9789728c51ed4af63328aaba6da67df35","previousRevision":"17","finalRevision":"18","rolledBack":false,"logLines":["Running helm upgrade"]}',
      '',
    ].join('\n'), {
      status: 200,
