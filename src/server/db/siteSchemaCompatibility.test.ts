  ...
  it.each([
    {
      ...
      expectedSql: [
        ...
        'ALTER TABLE sites ADD COLUMN responses_strip_image_generation_enabled integer NOT NULL DEFAULT 0;',
        'UPDATE sites SET responses_strip_image_generation_enabled = 0 WHERE responses_strip_image_generation_enabled IS NULL;',
    ...
    },
    {
      ...
      expectedSql: [
        ...
        'UPDATE "sites" SET "responses_strip_image_generation_enabled" = FALSE WHERE "responses_strip_image_generation_enabled" IS NULL',
