...
const zhToEn: Record<string, string> = {
  ...
  '4. 成本来源优先级：历史实测真实成本 → 价格域参考成本 → 未知模型路由成本兜底。': '4. Cost source priority: observed actual cost -> pricing-domain reference cost -> unknown-model routing fallback.',
