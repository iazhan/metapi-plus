...
const LINKS = [
  { label: 'GitHub', href: 'https://github.com/iazhan/metapi-plus', icon: '📂' },
  { label: 'GHCR', href: 'https://github.com/iazhan/metapi-plus/pkgs/container/metapi-plus', icon: '🐳' },
  ...
  return (
    <div className="animate-fade-in" style={{ maxWidth: 860 }}>
      ...
      <div className="page-header" style={{ marginBottom: 14 }}>
        <h2 className="page-title">{tr('关于 Metapi Plus')}</h2>
      </div>
      ...
      <div className="card animate-slide-up stagger-1" style={{ padding: 22, marginBottom: 14 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 14 }}>
          ...
          />
          <div>
            <div style={{ fontSize: 18, fontWeight: 700 }}>Metapi Plus</div>
      ...
      <div className="card animate-slide-up stagger-1" style={{ padding: 22, marginBottom: 14 }}>
        ...
        <div style={{ display: 'grid', gap: 8, fontSize: 13 }}>
          ...
          <div>GHCR：{latestDockerHubVersion || '暂无数据'}</div>
          <div>
      ...
      <div className="card animate-slide-up stagger-5" style={{ padding: 22 }}>
        ...
        <div style={{ fontSize: 13, color: 'var(--color-text-secondary)', lineHeight: 1.8 }}>
          {tr('Metapi Plus 完全自托管，所有数据（账号、令牌、路由、日志）均存储在本地 SQLite 数据库中，不会向任何第三方发送数据。代理请求仅在你的服务器与上游站点之间直连传输。')}
        </div>
      </div>
    </div>
  );
