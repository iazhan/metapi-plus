...
We as members, contributors, and maintainers pledge to make participation in the Metapi Plus community a harassment-free experience for everyone, regardless of age, body size, disability, ethnicity, gender identity and expression, level of experience, nationality, personal appearance, race, religion, or sexual identity and orientation.

作为 Metapi Plus 社区的成员、贡献者和维护者，我们承诺让每个人都能在无骚扰的环境中参与，无论年龄、体型、残疾、种族、性别认同和表达、经验水平、国籍、个人外貌、种族、宗教或性取向如何。
...
1. **Email** / **邮件**: `xigchn@163.com` with subject prefix `[Metapi Plus Conduct]` / 主题前缀为 `[Metapi Plus Conduct]`
...
- Any other spaces where an individual is representing the Metapi Plus project / 个人代表 Metapi Plus 项目的任何其他空间
...
If you have questions about this Code of Conduct, please open an issue or contact the maintainers at `xigchn@163.com`.

如果您对本行为准则有疑问，请开启 issue 或通过 `xigchn@163.com` 联系维护者。
