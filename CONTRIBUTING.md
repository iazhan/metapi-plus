...
Thank you for your interest in contributing to Metapi Plus! / 感谢您对 Metapi Plus 项目的贡献！

Metapi Plus is a meta-aggregation layer for AI API platforms (New API, One API, OneHub, etc.), providing unified proxy, intelligent routing, and centralized management.

Metapi Plus 是 AI API 聚合平台（New API、One API、OneHub 等）的元聚合层，提供统一代理、智能路由和集中管理。

## Before You Start / 开始之前

- Check existing [Issues](https://github.com/iazhan/metapi-plus/issues) and [Pull Requests](https://github.com/iazhan/metapi-plus/pulls) to avoid duplicates. / 检查现有的 [Issues](https://github.com/iazhan/metapi-plus/issues) 和 [Pull Requests](https://github.com/iazhan/metapi-plus/pulls) 以避免重复。
...
```bash
git clone https://github.com/YOUR_USERNAME/metapi-plus.git
cd metapi-plus
```
...
- 📖 [Documentation](https://iazhan.github.io/metapi-plus/) / [文档](https://iazhan.github.io/metapi-plus/)
- 💬 [GitHub Discussions](https://github.com/iazhan/metapi-plus/discussions) / [GitHub 讨论区](https://github.com/iazhan/metapi-plus/discussions)
- 🐛 [Issue Tracker](https://github.com/iazhan/metapi-plus/issues) / [Issue 跟踪](https://github.com/iazhan/metapi-plus/issues)
