...
</a><a href="https://github.com/iazhan/metapi-plus/stargazers">
...
> **Metapi Plus** 是基于 [cita-777/metapi](https://github.com/cita-777/metapi) 的社区维护增强版 fork，目标是修复长期未处理的问题、维护可发布版本，并尽量保持与上游 Metapi 的部署与数据兼容。
...
- 🐛 报告 Bug — [提交 Issue](https://github.com/iazhan/metapi-plus/issues)
- 💡 功能建议 — [发起讨论](https://github.com/iazhan/metapi-plus/issues)
- 🔧 代码贡献 — [提交 Pull Request](https://github.com/iazhan/metapi-plus/pulls)
...
Metapi Plus 继承自上游 Metapi。感谢所有为 Metapi 提交代码、反馈问题、提供思路和实测数据的朋友；这个项目的很多能力，都是在社区的真实使用和反复打磨中慢慢长出来的。
...
**⭐ 如果 Metapi Plus 对你有帮助，给个 Star 就是最大的支持！**
